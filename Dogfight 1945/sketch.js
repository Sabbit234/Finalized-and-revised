...
var gunFire_p, gunFire_e;

var bg_lvl_00, bg_lvl_01;
...
function preload()
{
  ...
  gunFire_p = loadSound("Assets/Audio/GunFire_p.mp3")
  gunFire_e = loadSound("Assets/Audio/GunFire_e.mp3")

  bg_lvl_00 = loadSound("Assets/Audio/BG_lvl_00.mp3")
  bg_lvl_01 = loadSound("Assets/Audio/BG_lvl_01.mp3")

  youWin = loadSound("Assets/Audio/youWin.mp3")
  youLose = loadSound("Assets/Audio/youLose.mp3")
